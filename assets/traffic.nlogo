...
to setup-cars
  ...
  create-turtles number-of-cars [
    set color blue
    let random-patch patch-at random-xcor 0
    let newx [pxcor] of random-patch
    set xcor newx
    set heading 90
...
to go
  ...
  if ticks = 50 [
    ask turtles [
    set speed-limit global-speed-limit
    ]
  ]
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <steppedValueSet variable="global-speed-limit" first="0" step="0.01" last="1"/>
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <metric>standard-deviation [speed] of turtles</metric>
    <enumeratedValueSet variable="acceleration">
      <value value="0.0045"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number-of-cars">
